// ===== Kép-fallback: ha nem tölthető, legyen kulturált placeholder
document.addEventListener('error', function(e){
  const el = e.target;
  if(el.tagName === 'IMG'){
    el.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 338"><rect width="600" height="338" fill="%23eef2f7"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="%2399a3b0" font-family="Arial" font-size="24">kép nem elérhető</text></svg>';
  }
}, true);
